...
from tensorflow.keras.layers import Conv2D, BatchNormalization, Activation, Input, ZeroPadding2D, MaxPooling2D, Flatten, Dense, Add, Lambda
...
class M64RN4_regression(M64RN4):
    ...
    def __init__(self, input_shape, data_augmentation):
        ...
        self.callback_path = '/raid/localscratch/rmarquar/models_logs_and_save/regression'
    ...
    def load_dataset(self, path_X_train, path_y_train, path_X_test, path_y_test):
        ...
        print('Shape X_train, X_test : %s, %s \nShape y_train, y_test : %s, %s' % (str(self.X_train.shape), str(self.X_test.shape), str(self.y_train.shape), str(self.y_test.shape)))
...
class M64RN4_distribution(M64RN4):
    ...
    def __init__(self, input_shape, data_augmentation, n_classes):
        super().__init__(input_shape, data_augmentation)
        self.callback_path = '/raid/localscratch/rmarquar/models_logs_and_save/distribution'
